...
general_rest]).
%session(co_creation_baseline, [general_wakeup, co_handshake, co_handshake_gesture_baseline, co_handshake_sound_baseline, co_handshake_led_baseline, co_handshake_ceremonie, general_rest]).
