...
%session(testing, [general_wakeup, test_chocolate, test_color, test_party, test_party2, test_color2, test_sound, test_emotion, test_sound2, test_animation, test_leds, test_posture, test_motion, general_rest]).
...
session(testing, [general_wakeup, test_chocolate, general_rest]).
