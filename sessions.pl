...
%session(testing, [general_wakeup, test_open, general_rest]).
%sessionOrder([testing]).
%multiSession(false).

% Session management
%session(co_creation, [general_wakeup, co_intro, co_tutorial_speech, co_tutorial_touch, co_tutorial_sound, co_tutorial_gesture, co_tutorial_lights, co_led_selection, co_tutorial_lights2, general_rest]).
session(co_creation, [general_wakeup, co_zoo_intro, co_zoo_elephant, general_rest]).
