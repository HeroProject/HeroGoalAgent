...
session(testing_short, [general_wakeup, test_leds, general_rest]).
...
% Co-creation
session(co_creation_short, [general_wakeup, co_handshake, co_handshake_gesture, co_handshake_sound, co_handshake_led, co_handshake_ceremonie, general_rest]).
