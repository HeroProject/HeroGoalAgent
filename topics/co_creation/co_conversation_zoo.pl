...
next(co_zoo_dolphin, s16downloadeno2, "true", s17downloadeno).

state(co_zoo_dolphin, s17downloadeno, question).
stateConfig(co_zoo_dolphin, s17downloadeno, [type = branch, context = "involvement_who_picks_option", options = ['uitzoeken', 'ik maak keuze'], defaultAnswer='uitzoeken',
...
text(co_zoo_dolphin, s17downloadeno, "Wil jij de beste optie uitzoeken of zal ik gewoon kiezen?").
stop_led_anim(co_zoo_dolphin, s17downloadeno).
next(co_zoo_dolphin, s17downloadeno, "success", s18downloaden).
next(co_zoo_dolphin, s17downloadeno, "fail", s17downloadenf).
