...
moveConfig(math_dialog, s2, [eventListener=['true'='RightBumperPressed', 'noanswer'='LeftBumperPressed'], goTimer=90000]).
...
moveConfig(math_dialog, s4, [eventListener=['correct'='RightBumperPressed', 'misheard'='LeftBumperPressed'], goTimer=5000]).
display(math_dialog, s4, "%math_given_answer%", always).
leds(math_dialog, s4, direct, ["RightFootLeds", "LeftFootLeds"], ["groen", "rood"]).
next(math_dialog, s4, "misheard", s4repeat).
next(math_dialog, s4, "correct", s5).
...
insert_minidialog_when_active(math_next, s2, [type=math]).
...
display_math_with_answer(math_help_tafel_rij_uitleg, s2).
next(math_help_tafel_rij_uitleg, s2, "true", s3).

move(math_help_tafel_rij_uitleg, s3, say).
text(math_help_tafel_rij_uitleg, s3, "Druk maar op mijn groene teen als je klaar bent om verder te gaan").
moveConfig(math_help_tafel_rij_uitleg, s3, [eventListener=['ready'='RightBumperPressed']]).
display_math_with_answer(math_help_tafel_rij_uitleg, s3).
leds(math_help_tafel_rij_uitleg, s3, direct, ["RightFootLeds"], ["groen"]).
next(math_help_tafel_rij_uitleg, s3, "ready", s4).

move(math_help_tafel_rij_uitleg, s4, say).
leds(math_help_tafel_rij_uitleg, s4, reset).
...
text(math_help_steunsom_uitleg, s4, "Als ik nu %math_left% keer %math_right% uitreken, dan kom ik uit op %math_answer%.").
...
text(math_help_double_8_uitleg, s3, "Als we dat antwoord verdubbelen berekenen we eigenlijk 4 x %math_right%").
display(math_help_double_8_uitleg, s3, "4 x %math_right%", always).
...
display(math_help_double_8_uitleg, s5, "8 x %math_right%", always).
...
moveConfig(math_hint_dialog, s1, [eventListener=['true'='RightBumperPressed', 'noanswer'='LeftBumperPressed'], goTimer=90000]).
...
moveConfig(math_hint_dialog, s4, [eventListener=['correct'='RightBumperPressed', 'misheard'='LeftBumperPressed'], goTimer=5000]).
display(math_hint_dialog, s4, "%math_given_answer%", always).
leds(math_hint_dialog, s4, direct, ["RightFootLeds", "LeftFootLeds"], ["groen", "rood"]).
next(math_hint_dialog, s4, "misheard", s4repeat).
next(math_hint_dialog, s4, "correct", s5).
...
text(math_hint_dialog, s7, "Zullen we samen naar de hints kijken?").
