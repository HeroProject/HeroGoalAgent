...
move(intro, s1q, say).
moveConfig(intro, s1q, [waitTimer=3000]).
...
move(intro, s2q, question).
moveConfig(intro, s2q, [type=openend, context='answer_open', inputModality=[speech=1]]).
...
move(intro, s3q, question).
moveConfig(intro, s3q, [type=openend, context='answer_open', inputModality=[speech=1]]).
...
move(intro, s4q, question).
moveConfig(intro, s4q, [type=yesno, context='answer_yesno']).
...
move(algemeen, s1q, question).
moveConfig(algemeen, s1q, [type=quiz, context='answer_sleep', options=["Meestal goed", "Soms goed soms slecht", "Meestal slecht"], correctAnswer=["Meestal goed"]]).
...
move(activiteiten, s1q, question).
moveConfig(activiteiten, s1q, [type=openend, context='answer_open', inputModality=[speech=1]]).
...
move(routine, s2y, say).
text(routine,  s2y, "Ik ben benieuwd wat jouw routine is.").
next(routine,  s2y, "true",  s2yq).

move(routine, s2yq, question).
moveConfig(routine, s2yq, [type=yesno, context='answer_yesno']).
...
move(routine, s3yq, question). % TODO: complicated tablet task?
moveConfig(routine, s3yq, [type=yesno, context='answer_yesno']).
...
move(routine, s1n2, say).
text(routine,  s1n2, "Een routine kan daarbij helpen.").
next(routine,  s1n2, "true", s2nq).

move(routine, s2nq, question).
moveConfig(routine, s2nq, [type=yesno, context='answer_yesno']).
...
move(routine, s3nq, question). % TODO: complicated tablet task?
moveConfig(routine, s3nq, [type=yesno, context='answer_yesno']).
...
move(slaapkamer, s2q, question).
moveConfig(slaapkamer, s2q, [type=quiz, context='answer_sleep', options=["Donker", "Licht", "Donker met nachtlampje"], correctAnswer=["Donker"]]).
...
move(piekeren, s1, say).
text(piekeren,  s1, "Oke, volgende vraag.").
next(piekeren,  s1, "true",  s1q).

move(piekeren, s1q, question).
moveConfig(piekeren, s1q, [type=yesno, context='answer_yesno']).
...
move(piekeren, s2q, question).
moveConfig(piekeren, s2q, [type=yesno, context='answer_yesno']).
...
move(wakker, s1q, question).
moveConfig(wakker, s1q, [type=yesno, context='answer_yesno']).
...
move(bewegen, s1q, question).
moveConfig(bewegen, s1q, [type=yesno, context='answer_yesno']).
...
move(etendrinken, s2q, question).
moveConfig(etendrinken, s2q, [type=yesno, context='answer_yesno']).
...
move(etendrinken, s2yq, question). % TODO: complicated tablet task?
moveConfig(etendrinken, s2yq, [type=yesno, context='answer_yesno']).
...
move(afsluiting, s1q, question).
moveConfig(afsluiting, s1q, [type=yesno, context='answer_yesno']).
...
move(afsluiting, s1i2, say). % FIXME: tablet show
