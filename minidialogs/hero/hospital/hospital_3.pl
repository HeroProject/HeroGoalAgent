...
%moveConfig(ho3_koelkast, s57, [next='RightBumperPressed']).
...
%moveConfig(ho3_graafmachine, s91, [next='RightBumperPressed']).
%next(ho3_graafmachine,  s91, "true",  s92).
...
%%% Next story?		 	                           %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
move(ho3_next_story, s1, question).
moveConfig(ho3_next_story, s1, [type=yesno, context='answer_yesno']).
...
move(ho3_next_story, s4y, question).
moveConfig(ho3_next_story, s4y, [type=input, context='choose_story', options= ["koelkast", "graafmachine"], umVariable=ho3_next_story]).
...
move(ho3_goodbye, s6, question).
moveConfig(ho3_goodbye, s6, [type=yesno, context='answer_yesno']).
...
move(ho3_goodbye, s6n, question).
moveConfig(ho3_goodbye, s6n, [type=openend, context='answer_open', inputModality=[speech=1]]).
