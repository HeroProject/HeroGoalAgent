...
%% tutorial_feet %%
minidialog(tutorial_feet, [type=functional, function=tutorial]).

move(tutorial_feet, s1, say).
text(tutorial_feet, s1, "Als het me even niet lukt om je goed te verstaan").
next(tutorial_feet, s1, "true", s2).

move(tutorial_feet, s2, say).
text(tutorial_feet, s2, "dan heb ik een oplossing").
next(tutorial_feet, s2, "true", s3).

move(tutorial_feet, s3, say).
text(tutorial_feet, s3, "Je kunt dan antwoord geven via mijn grijze, tenen").
next(tutorial_feet, s3, "true", s4).

move(tutorial_feet, s4, say).
text(tutorial_feet, s4, "Dat zijn namelijk knopjes").
next(tutorial_feet, s4, "true", s5).

move(tutorial_feet, s5, say).
text(tutorial_feet, s5, "Links, waar het lampje nu groen is, betekent ja \pau=400\ en rechts, waar het lampje nu rood is betekent nee").
leds(tutorial_feet, s5, direct, ['LeftFootLeds', 'RightFootLeds'], ['red', 'green']).
next(tutorial_feet, s5, "true", s6).

move(tutorial_feet, s6, say).
text(tutorial_feet, s6, "Bij een meerkeuze vraag zal ik wat opties opnoemen").
next(tutorial_feet, s6, "true", s7).

move(tutorial_feet, s7, say).
text(tutorial_feet, s7, "Dan kun je op de ja knop drukken bij het beste antwoord").
leds(tutorial_feet, s7, direct, ['LeftFootLeds', 'RightFootLeds'], ['wit', 'wit']).
next(tutorial_feet, s7, "true", s8).

move(tutorial_feet, s8, say).
text(tutorial_feet, s8, "Laten we dat even oefenen. \pau=400\ ").
next(tutorial_feet, s8, "true", s9).

move(tutorial_feet, s9, question).
moveConfig(tutorial_feet, s9, [type=input, options=['paars', 'blauw', 'groen', 'oranje'], inputModality=[feet=3], maxAnswerTime=[feet=5000], fast=yes]).
text(tutorial_feet, s9, "Welke kleur hebben mijn ogen nu?").
leds(tutorial_feet, s9, direct, ['FaceLeds'], ['groen']).
next(tutorial_feet, s9, "groen", s10correct1).
next(tutorial_feet, s9, "donkergroen", s10correct1).
next(tutorial_feet, s9, "lichtgroen", s10correct1).
next(tutorial_feet, s9, "_others", s10incorrect1).
next(tutorial_feet, s9, "fail", s11).

move(tutorial_feet, s10correct1, say).
text(tutorial_feet, s10correct1, "Jazeker! Ze zijn inderdaad groen.").
next(tutorial_feet, s10correct1, "true", s11).

move(tutorial_feet, s10incorrect1, say).
text(tutorial_feet, s10incorrect1, "Die kleur kunnen ze inderdaad worden, maar deze keer waren ze echt groen.").
next(tutorial_feet, s10incorrect1, "true", s10incorrect2).

move(tutorial_feet, s10incorrect2, say).
text(tutorial_feet, s10incorrect2, "Mocht je te laat of te vroeg hebben gedrukt, alle antwoorden komen twee keer voorbij. Je kunt dan eventjes wachten met drukken tot jouw antwoord terug komt.").
next(tutorial_feet, s10incorrect2, "true", s11).

move(tutorial_feet, s11, say).
text(tutorial_feet, s11, "Mocht jouw antwoord er niet tussen zitten, dan kun je eentje kiezen die het beste bij jou past.").
leds(tutorial_feet, s11, direct, ['FaceLeds'], ['Wit']).
