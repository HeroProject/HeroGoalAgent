%%%% HEADER %%%%
%% dagdromen_sport %%
minidialog(dagdromen_sport, [type=chitchat, theme=personalia, topic=sport]).
...
moveConfig(dagdromen_sport, s4nee1, [type=yesno, context='answer_yesno', umVariable=kind_interesse_sport]).
...
moveConfig(dagdromen_sport, s7, [type=yesno, context='answer_yesno', umVariable=goede_sportrobot_janee]).
...
text(dagdromen_sport, s8nee1, "humhum, dan zal ik er nog eens beter over nadenken.").
