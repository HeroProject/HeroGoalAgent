...
move(rs_intro, s2, question).
moveConfig(rs_intro, s2, [type=openend, context='answer_open', inputModality=[speech=1], maxAnswerTime=[speechopenend=3000]]).
...
move(rs_intro, s4, say).
text(rs_intro,  s4, "Mijn naam is Hero.").
next(rs_intro,  s4, "true",  s5).

move(rs_intro, s5, question).
moveConfig(rs_intro, s5, [type=yesno, context='answer_yesno']).
...
%%% Thread 1, sequence 1	                           %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
move(rs_thread_1_seq_1, s1, say).
text(rs_thread_1_seq_1,  s1, "Sorry dat ik zo veel praat! Het is gewoon.").
next(rs_thread_1_seq_1,  s1, "true",  s1b).

move(rs_thread_1_seq_1, s1b, say).
text(rs_thread_1_seq_1,  s1b, "Ik ben een beetje zze zze ze ze zenuwachtig.").
anim(rs_thread_1_seq_1, s1b, onRobot, "nervous/behavior_1").
next(rs_thread_1_seq_1,  s1b, "true",  s2).

move(rs_thread_1_seq_1, s2, question).
moveConfig(rs_thread_1_seq_1, s2, [type=openend, context='answer_open', inputModality=[speech=1], maxAnswerTime=[speechopenend=3000]]).
...
move(rs_thread_1_seq_1, s3b, say).
...
move(rs_thread_1_seq_1, s3c, say).
...
move(rs_thread_1_seq_1, s4, say).
audio(rs_thread_1_seq_1, s4, file, "resources/sounds/vacuum2.wav").
leds(rs_thread_1_seq_1, s4, direct, "eyes", "rotate", ["green"], 500).
next(rs_thread_1_seq_1,  s4, "true",  s5).

move(rs_thread_1_seq_1, s5, say).
leds(rs_thread_1_seq_1, s5, reset).
text(rs_thread_1_seq_1,  s5, "en wie het best origami kan vouwen").
anim(rs_thread_1_seq_1, s5, onRobot, "wiggle_fingers/behavior_1").
next(rs_thread_1_seq_1,  s5, "true",  s7).

move(rs_thread_1_seq_1, s7, say).
...
move(rs_thread_1_seq_1, s16y, say).
text(rs_thread_1_seq_1,  s16y, "Cool!").
next(rs_thread_1_seq_1,  s16y, "true",  s17y).

move(rs_thread_1_seq_1, s17y, question).
moveConfig(rs_thread_1_seq_1, s17y, [type=openend, context='answer_open', inputModality=[speech=1], maxAnswerTime=[speechopenend=5000]]).
text(rs_thread_1_seq_1, s17y, " Waarin dan?").
next(rs_thread_1_seq_1, s17y, 'success', s18).
next(rs_thread_1_seq_1, s17y, 'fail', s18n).

move(rs_thread_1_seq_1, s16n, question).
moveConfig(rs_thread_1_seq_1, s16n, [type=yesno, context='answer_yesno']).
...
move(rs_thread_1_seq_1, s18, say).
...
move(rs_thread_1_seq_1, s28, say).
...
move(rs_thread_2_seq_1, s24f, say).
text(rs_thread_2_seq_1,  s24f, "Zullen we voor vliegen gaan. Altijd al willen doen.").
leds(rs_thread_2_seq_1, s24f, reset).
next(rs_thread_2_seq_1,  s24f, "true",  s25vliegen).

move(rs_thread_2_seq_1, s25vliegen, say).
text(rs_thread_2_seq_1,  s25vliegen, "Vliegen! Te gek").
leds(rs_thread_2_seq_1,  s25vliegen, direct, ['FaceLeds', 'ChestLeds'], ['green', 'green']).
next(rs_thread_2_seq_1,  s25vliegen, "true",  s26vliegen).

move(rs_thread_2_seq_1, s26vliegen, question).
moveConfig(rs_thread_2_seq_1, s26vliegen, [type=input, context='answer_rs_thread_2_snel_of_langzaam', options=['snel', 'langzaam'], defaultAnswer="snel"]).
...
move(rs_thread_2_seq_1, s27vliegen, branchingPoint, rs_thread_2_seq_1_s26vliegen).
...
move(rs_thread_2_seq_1, s29vliegen, question).
moveConfig(rs_thread_2_seq_1, s29vliegen, [type=input, context='answer_land', inputModality=[speech=2]]).
...
move(rs_thread_2_seq_1, s25zwemmen, say).
text(rs_thread_2_seq_1,  s25zwemmen, "Zwemmen! Bizar. Kletsnat.").
leds(rs_thread_2_seq_1,  s25zwemmen, direct, ['FaceLeds', 'ChestLeds'], ['blue', 'blue']).
next(rs_thread_2_seq_1,  s25zwemmen, "true",  s26zwemmen).

move(rs_thread_2_seq_1, s26zwemmen, question).
moveConfig(rs_thread_2_seq_1, s26zwemmen, [type=input, context='answer_rs_thread_2_snel_of_langzaam', options=['snel', 'langzaam'], defaultAnswer="snel"]).
...
move(rs_thread_2_seq_1, s27zwemmen, branchingPoint, rs_thread_2_seq_1_s26zwemmen).
...
move(rs_thread_2_seq_1, s29zwemmen, question).
moveConfig(rs_thread_2_seq_1, s29zwemmen, [type=input, context='answer_land', inputModality=[speech=2]]).
...
move(rs_thread_2_seq_1, s25racen, say).
text(rs_thread_2_seq_1,  s25racen, "Racen als een race-auto. Wielen aan mijn enkels en knieën.").
leds(rs_thread_2_seq_1,  s25racen, direct, ['FaceLeds', 'ChestLeds'], ['yellow', 'yellow']).
next(rs_thread_2_seq_1,  s25racen, "true",  s26racen).

move(rs_thread_2_seq_1, s26racen, question).
moveConfig(rs_thread_2_seq_1, s26racen, [type=input, context='answer_rs_thread_2_snel_of_langzaam', options=['snel', 'langzaam'], defaultAnswer="snel"]).
...
move(rs_thread_2_seq_1, s27racen, branchingPoint, rs_thread_2_seq_1_s26racen).
...
move(rs_thread_2_seq_1, s29racen, question).
moveConfig(rs_thread_2_seq_1, s29racen, [type=input, context='answer_land', inputModality=[speech=2]]).
...
move(rs_thread_2_seq_1, s30, question).
moveConfig(rs_thread_2_seq_1, s30, [type=openend, context='answer_open', inputModality=[speech=1]]).
leds(rs_thread_2_seq_1,  s30, direct, ['FaceLeds', 'ChestLeds'], ['white', 'white']).
...
move(rs_thread_2_seq_1, s31, say).
