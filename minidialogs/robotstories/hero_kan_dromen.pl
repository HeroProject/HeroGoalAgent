...
moveConfig(hero_kan_dromen, s10, [type=yesno, context='answer_yesno']).
...
moveConfig(hero_kan_dromen, s18, [type=input, context="hoe_heet_dromen_antwoorden", options=['Dromen', 'dromen'], umVariable=hoe_heet_dromen]).
...
moveConfig(hero_kan_dromen, s23, [type=yesno, context='answer_yesno']).
