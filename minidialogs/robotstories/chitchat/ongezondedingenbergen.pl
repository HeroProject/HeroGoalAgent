...
moveConfig(ongezondedingenbergen, s8, [type=input, context="food", options=['ijs', 'chocola', 'koekjes', 'snoep', 'chips'], fast=yes, umVariable=ongezonde_dingen_bergen]).
...
text(ongezondedingenbergen, s11, "Misschien kan ik dan wel zelf de robo spelen organiseren!").
next(ongezondedingenbergen, s11, "true", s12).

move(ongezondedingenbergen, s12, say).
text(ongezondedingenbergen, s12, "Ik zou het dan veranderen naar een robo spelen voor samenwerkingen tussen robots en kinderen!").
...
text(ongezondedingenbergen, s15, "Vind je dat de leukste prijs, zo'n hele berg eten?").
...
moveConfig(ongezondedingenbergen, s16niet_goede_prijs3, [type=openend, context='answer_open', inputModality=[speech=1], umVariable=prijs_voor_kind]).
...
next(ongezondedingenbergen, s16niet_goede_prijs3, "fail", s16got_no_prijs1).
...
text(ongezondedingenbergen, s16got_no_prijs3, "voor ik de robo spelen mag organiseren").
