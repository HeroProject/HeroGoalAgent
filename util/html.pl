...
show_hints_with_answer([FirstHint | RestOfHints], Left, [FirstAnswer | RestOfAnswers], [HintHtml | RestOfHtml]) :- show_hint_with_answer(Hint),
	format(atom(HintHtml), Hint, [Left, FirstHint, FirstAnswer]), show_hints_with_answer(RestOfHints,  Left, RestOfAnswers, RestOfHtml).
show_hints_with_answer([], _, _, []).
show_math_with_hints_with_answers([Left, Right, Answer], Hints, HintAnswers, Html) :- show_math_with_answer(Main), format(atom(MainHtml), Main, [Left, Right, Answer]),
					       show_hints_with_answer(Hints, Left, HintAnswers, HintsHtmlList), atomic_list_concat(HintsHtmlList, HintsHtml),
					       atom_concat(MainHtml, HintsHtml, Html).
